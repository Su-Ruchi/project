...
class GrowingMedium extends StatefulWidget {
  @override
  _GrowingMediumState createState() => _GrowingMediumState();
}

class _GrowingMediumState extends State<GrowingMedium> {
...
/*        title: Text("Seeds",
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Container(
              child: Image.asset("asset/image/growing_t.png"),
